...
public class EntityFactory {
    ...
    Entity player = new Entity();
        player.addComponent(new PositionComponent((int)x, (int)y));
    ...
    public static Entity createWanderer(double x, double y) {
        ...
        npc.addComponent(new PositionComponent((int)x, (int)y));
    ...
    public static Entity createStaticObject(double x, double y) {
        ...
        obj.addComponent(new PositionComponent((int)x, (int)y));
